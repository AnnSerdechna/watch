...
export const FavouriteBtn: FC<{ isFavourite: boolean, btnSize?: 'sm' | 'default', className?: string }> = ({ isFavourite, className, btnSize = 'default' }) => (
  <button
